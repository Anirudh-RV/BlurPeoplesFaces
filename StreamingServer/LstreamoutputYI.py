                ...
                for res in resultyolo:
                    if res["label"] == "whole":
                        ...
                        if len(listofmatches) != 0:
                            # add guassian blur here
                            blur = cv2.GaussianBlur(img1[coordinatesStr['y1']:coordinatesStr['y2'], coordinatesStr['x1']:coordinatesStr['x2']], (51,51), 0)
                            img1[coordinatesStr['y1']:coordinatesStr['y2'], coordinatesStr['x1']:coordinatesStr['x2']] = blur
